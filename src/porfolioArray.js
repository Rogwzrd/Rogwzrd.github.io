const porfolioArray =[
    {
        url: "https://salty-lowlands-12733.herokuapp.com/",
        title: "GYST",
        subtitle: "React, Node.js, MongoDb, PassPort, Express, Material UI",
        imgSrc: "gyst.png",
        commentbox:`This application was the final project of my bootcamp. The app was made to help users manage three 
        large portions of their life. Their money, social life, and time. I worked on  the time component. I created the
         time  databases and schemas, the endpoints for the database, the landing page, and the entire front end of the
          time component.`,
    },
    {
       ...
       imgSrc: "scraper.png",
        commentbox: `This project is a full stack application that scrapes the NPR webpage to scrap articles to a database.
         From there users can then select specific articles to save for to view later and also add notes. I built the entire
    ...
    },
    {
        ...
        imgSrc:"tcg.png",
        commentbox:`This is a deck building application for the Pokemon trading card game. Users have the ability to 
        search for cards and then use  them to build decks. I built the front end of this application. I used bootstrap 
